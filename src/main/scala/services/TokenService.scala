...
class TokenService(val userRepository: UserRepository)(implicit ec: ExecutionContext)
    extends UserJson {

  // Key used by the hashing library, you might want to fetch this from somewhere else, such as
  // Config service
  ...
  // Convenience method that determines wether a token is valid
